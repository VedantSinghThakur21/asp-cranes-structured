...
import {
  ...
  SiteAssessment as SiteAssessmentType,
...
export function SiteAssessment() {
  ...
  const updateConstraintNotes = (constraintId: string, notes: string) => {
    setSelectedConstraints(prev => prev.map(c => (c.id === constraintId ? { ...c, notes } : c)));
  };
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      {constraint.description && (
                        <p className="text-sm text-gray-500 mt-1">{constraint.description}</p>
                      )}
                      ...
                      {selectedConstraints.some(c => c.id === constraint.id) && (
                        <TextArea
                          ...
                          value={selectedConstraints.find(c => c.id === constraint.id)?.notes || ''}
        ...
        <CardContent>
          <div className="max-w-md">
            <div className="flex gap-3">
              ...
              />
              <Button onClick={handleRemoteAssessment} leftIcon={<Send size={16} />}>
                Send Link
              </Button>
            </div>
              ...
              {selectedConstraints.length > 0 ? (
                <div className="space-y-3">
                  {selectedConstraints.map(constraint => (
                    <div key={constraint.id} className="bg-gray-50 rounded-lg p-3">
                      <div className="flex items-center gap-2 text-sm font-medium text-gray-900">
                        <Tag size={14} />
                        {constraint.label}
                      </div>
                      {constraint.notes && (
                        <p className="mt-1 text-sm text-gray-600">{constraint.notes}</p>
                      )}
                    </div>
                  ))}
                </div>
            ...
            >
              ...
              <div className="p-4">
                <div className="relative">
                  <img src={selectedImage.preview} alt="Annotation" className="max-w-full h-auto" />
